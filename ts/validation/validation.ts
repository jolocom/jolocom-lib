...
import { JsonLdDigestible, SignedJsonLd } from './jsonLdValidator'
...
export async function validateJsonLd(
  ...
  const data = new JsonLdDigestible(json)
  return await JolocomLib.KeyProvider.verifyDigestable(publicKey, data)
}
