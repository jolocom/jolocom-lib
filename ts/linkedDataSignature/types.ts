...
export const getLDSignatureTypeByKeyType = (
  keyType: KeyTypes,
): LinkedDataSignatureSuite => {
  const keyTypeToLdSignatureSuite = {
    [KeyTypes.ecdsaSecp256k1VerificationKey2019]:
      LinkedDataSignatureSuite.EcdsaSecp256k1Signature2019,
    [KeyTypes.ecdsaSecp256k1RecoveryMethod2020]:
      LinkedDataSignatureSuite.EcdsaSecp256k1Signature2019,
    [KeyTypes.ed25519VerificationKey2018]:
      LinkedDataSignatureSuite.Ed25519Signature2018,
  }
