...
import { testPrivateEthereumKey, testPrivateEthereumKey3 } from '../data/keys.data'
...
const deployContract = async () => {
  ...
  const address = await registryContract.TestDeployment.deployIdentityContract(web3, deployerAddress)
  return address
}
