...
__decorate([
    class_transformer_1.Expose({ name: 'prevSignatureValue' })
], EcdsaLinkedDataSignature.prototype, "prevSignature", null);
__decorate([
    class_transformer_1.Expose()
