...
import { IDigestable, ILinkedDataSignature, ProofChainsMap } from '../../linkedDataSignature/types';
...
export declare class SignedCredential implements IDigestable {
    ...
    readonly proofs: ILinkedDataSignature[];
    readonly proofChains: ProofChainsMap;
    addChainedSignature(sig: ILinkedDataSignature, prevSigKeyId: string): Promise<void>;
    subject: string;
    claim: IClaimSection;
    name: string;
